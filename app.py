...
st.set_page_config(page_title="Prosopographical Research Demo", layout="wide")

DATA_DIR = Path(__file__).parent / "data"
DATA_FILE = DATA_DIR / "aggregated_data.jsonl"
SOURCES_FILE = DATA_DIR / "aggregated_sources.jsonl"
...
st.title("Prosopographical Research Demo")
st.caption("Automated biographical information extraction for international elites")

if not DATA_FILE.exists() or not SOURCES_FILE.exists():
    st.error("Data files not found. Please ensure data/ directory contains aggregated_data.jsonl and aggregated_sources.jsonl")
    st.stop()
